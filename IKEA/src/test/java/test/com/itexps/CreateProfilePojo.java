...
public class CreateProfilePojo {
    ...
    public CreateProfilePojo(String firstName, String lastName, String birthDate, String address, String address1, String cityName, String zipCode, String email, String password, int otpInput0, int otpInput1, int otpInput2, int otpInput3, int otpInput4, int otpInput5) {
    ...
    public String toString() {
        return "CreateProfilePojo{" + "firstName=" + firstName + ", lastName=" + lastName + ", birthDate=" + birthDate + ", address=" + address + ", address1=" + address1 + ", cityName=" + cityName + ", zipCode=" + zipCode + ", email=" + email + ", password=" + password + ", otpInput0=" + otpInput0 + ", otpInput1=" + otpInput1 + ", otpInput2=" + otpInput2 + ", otpInput3=" + otpInput3 + ", otpInput4=" + otpInput4 + ", otpInput5=" + otpInput5 + '}';
    }
