...
public class FileUtil {
     public static CreateProfilePojo getData() throws Exception {

        //read excel file
        FileInputStream inputStream = new FileInputStream(new File("C:\\data\\createprofile.xlsx"));
       ...
       //get first row
        ...
        //Populate POJO
       CreateProfilePojo createprofile  = new CreateProfilePojo (firstName, lastName,birthDate,address,address1,
